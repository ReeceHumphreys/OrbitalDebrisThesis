...
\begin{figure}[H]
	\begin{adjustbox}{max width=1\linewidth,center}
		...
		\subfigure[]{\label{fig:a}\includegraphics[width=0.5\textwidth]{N_f_vs_A}}
		\subfigure[]{\label{fig:b}\includegraphics[width=0.5\textwidth]{N_f_vs_M}}
	\end{adjustbox}
	\caption{The characteristic length distribution produced by ODAP of a catastrophic collision involving a rocket body with a mass of 1000kg, a projectile of mass 10kg, and an impact velocity of 10 km/s. }
\end{figure}
...
\begin{table}[H]
		...
		\caption{(NASA Breakup Model Implementation Comparison of results \cite{rossi_nasa_nodate}.}
...
\begin{figure}[h!]
	\begin{adjustbox}{max width=1\linewidth,center}
		\centering     %%% not \center
		\subfigure[]{\label{fig:a}\includegraphics[width=0.5\textwidth]{Starlink_altitudes}}
		\subfigure[]{\label{fig:b}\includegraphics[width=0.5\textwidth]{oxp_altitudes}}
	\end{adjustbox}
...
%$$\left\langle \left(P_n-\cfrac{N}{M}\right)^2 \right\rangle = ... = \cfrac{N}{M}\left(1-\cfrac{N}{M}\right) . $$
